...
public class BooksApi {
  // The private final BookService bookService tells us that we are going to be
  // using a bookService and that it will not be changing.
  private final BookService bookService;

  // Then, we use dependency injection to make it available in our controller.
